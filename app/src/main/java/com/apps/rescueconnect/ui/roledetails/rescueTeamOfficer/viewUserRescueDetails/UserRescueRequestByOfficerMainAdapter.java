...
public class UserRescueRequestByOfficerMainAdapter extends RecyclerView.Adapter<UserRescueRequestByOfficerMainAdapter.UserRescueRequestAdapterViewHolder> {

    private static final String TAG = UserRescueRequestByOfficerMainAdapter.class.getSimpleName();
    /**
    ...
    public UserRescueRequestByOfficerMainAdapter(Context context, List<RescueRequestMaster> rescueRequestMasterList, UserRescueRequestItemClickListener listener) {
            ...
            if (rescueRequestMasterList.size() > 0) {
                ...
                if (rescueRequestMaster != null) {
                    ...
                    holder.textAssign.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            listener.userRescueRequestAssignClicked(mainPosition, rescueRequestMaster,holder.textUserRescueRequestStatus.getText().toString());
                        }
                    });
                }
            }
    ...
    public interface UserRescueRequestItemClickListener {
        ...
        void userRescueRequestAssignClicked(int position, RescueRequestMaster rescueRequestMaster,  String userRescueRequestStatus);

        void userRescueRequestClicked(int position, RescueRequestMaster rescueRequestMaster, ImageView imageView, TextView textView);
    }
